...
홀로 프로젝트를 진행하며 기획 단계부터 컴포넌트 분리, 믹스인 및 변수 활용 등 유지보수성을 고려한 개발에 힘썼으며, 이를 통해 저의 탄탄한 개발 역량을 보여드리고자 합니다.
...
- **프로젝트**
  ...
  1. Portfolio: 기술 역량과 프로젝트 경험을 담은 프론트엔드 포트폴리오
  2. Doody(두디): 밸런스 게임을 중심으로 한 사용자 참여형 웹사이트
  3. Monzi(먼지): 일정 관리 웹사이트
  4. Ripo(리포): 디자인 문구 쇼핑몰 웹사이트
  5. 떠나봅서: 제주 여행 정보 및 커뮤니티 웹사이트
  6. ZFLIX: 영화 및 TV 프로그램 정보 제공 웹사이트
  7. 풀무원: 풀무원 웹사이트 리뉴얼 프로젝트
